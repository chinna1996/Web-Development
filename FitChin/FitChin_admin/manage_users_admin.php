...
<?php
$result=mysqli_query($connection,"select user_id, user_name, user_password from admin_login")or die ("query 2 incorrect.......");
...
<a href='manage_users_admin.php?user_id=$user_id&action=delete'>Delete</a>
</td></tr>";
}
