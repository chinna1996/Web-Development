...
<html>
    ...
    <style>
body {
  background-image: url("img/gymbackground.jpg");
  ...
  background-size: cover;
        ...
        <div>
           ...
           <div class="container">
               ...
               <div class="row">
                  <h2>Any Dietry Preferences?</h2>

                   <div class="col-xs-4">
                       <div  class="thumbnail">

                           <a href="femalemusclemassnone.php">
                   ...
                   <div class="col-xs-4">
                       <div class="thumbnail">
                           <a href="femalemusclemassvegan.php">
                   ...
                   <div class="col-xs-4">
                       <div class="thumbnail">
                           <a href="femalemusclemassgluten.php">
