                ...
                <div class="row">
                  ...
                  <div class="col-xs-4">
                      <div class="thumbnail">
                        ...
                        <center>
                      <h2><font color="red">Protein Bar</font></h2>
                    </center>
                            ...
                            <?php if(!isset($_SESSION['email'])){  ?>
                                ...
                                <?php
                                    ...
                                    if(check_if_added_to_cart(7)){
                                        ...
                                        ?>
                                        <a href="cart_add_proteinbar.php?id=7" class="btn btn-block btn-primary " name="add" value="add" class="btn btn-block btr-primary">Add to cart</a>
                                        <?php
                                    }
                                }
                                ?>
