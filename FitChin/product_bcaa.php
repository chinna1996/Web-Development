            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xs-4">
                        <div class="thumbnail">
                          <center>
                          <h2><font color="red">BCAA</font></h2>
                        </center>
                          <center>
                              <div class="caption">
                                  ...
                                  <?php if(!isset($_SESSION['email'])){  ?>
                                      ...
                                      <?php
                                          ...
                                          if(check_if_added_to_cart(2)){
                                              ...
                                              ?>
                                              <a href="cart_add_bcaa.php?id=2" class="btn btn-block btn-primary" name="add" value="add" class="btn btn-block btr-primary">Add to cart</a>
                                              <?php
                                          }
                                      }
                                      ?>
