<?php
    ...
    $user_authentication_query="select id,email from users_personaltrainers where email='$email' and password='$password'";
    ...
    if($rows_fetched==0){
        ...
        <meta http-equiv="refresh" content="1;url=login3.php" />
        <?php
